...
const priser = () => {
  return (
    <Container>
      ...
      <ExtLink style={{textTransform: "uppercase", marginTop: "15px", display: "block"}}href="https://www.danskkiropraktorforening.dk/media/1126/speciale-53-honorar-og-tilskud-pr-1-oktober-2018.pdf" target="_blank" rel="noopener norefferer">Klik for gældende priser</ExtLink>
    </Container>
  )
}
