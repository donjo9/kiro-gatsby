  ...
  return (
    <Container>
      ...
      <Body>
        ...
        <h3>Offentlige Sygesikring</h3> yder tilskud til behandling hos
        kiropraktoren. Det sker nøjagtig som hos lægen ved at patienten
        kvitterer for behandlingen, ved at vise sygesikringsbeviset ved hver
        konsultation. Patienten betaler sin andel af regningen til
        kiropraktoren, der afregner den enkelte patients tilskud direkte med
        Sygesikringen. Er du medlem af sygesikringen “Danmark” yder denne
        forening også tilskud til kiropraktisk behandling.
      </Body>
      <Title>DER KRÆVES INGEN LÆGEHENVISNING FOR TILSKUD</Title>
      <Body>
        Honorarer og tilskud pr. 1. oktober 2020: Ifølge Landsoverenskomsten
